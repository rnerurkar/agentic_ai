...
# This script ensures you are always working on the agentic_ai_implementation branch

Write-Host "🔍 Checking current branch..." -ForegroundColor Cyan
$currentBranch = git branch --show-current

if ($currentBranch -ne "agentic_ai_implementation") {
    Write-Host "⚠️  Warning: You are on branch: $currentBranch" -ForegroundColor Yellow
